...
[处理器架构的演进：从单周期到流水线.pptx](https://bosc.yuque.com/attachments/yuque/0/2026/pptx/66996431/1778495305745-b832f277-9876-470a-9f5c-adc35cd2fe52.pptx)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/66996431/1778225946770-0e3107d4-6f64-456d-afba-3311d80cb58b.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/66996431/1778225769773-e4e55b5a-b6fb-44d4-90e5-564bb5695932.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/66996431/1778227536200-4ab59da8-6ea5-4d03-ab35-bfbbaa443820.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/66996431/1778230448013-ec10b75f-dffa-492a-848b-6430dee99bac.png)
...
`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">lw</font>`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">指令的正确</font>`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">$s0</font>`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">值，</font>**<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">最早在周期 4 的 MEM 阶段结束时才能拿到</font>**<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">，周期 5 的 WB 阶段才会写入寄存器堆 RF。但依赖它的</font>`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">and</font>`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">指令：周期 3 的 ID 阶段，就要从 RF 中读取</font>`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">$s0</font>`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">的值；周期 4 的 EX 阶段，就要用</font>`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">$s0</font>`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">的值完成与运算。时序完全错位：</font>`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">and</font>`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">要用结果的时候，</font>`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">lw</font>`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">甚至还没从内存里把数据读出来，就算用数据转发（旁路），也无法解决 ——ALU 运算在周期前半段完成，内存读数据在周期后半段完成，同一个周期内根本来不及把 MEM 的结果送给 EX 阶段的 ALU。</font>
...
| `<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">and $t0</font>` | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">-</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">IF</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">暂停</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">ID</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">EX</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">MEM</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">WB</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">-</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">-</font> |
| `<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">or $t1</font>` | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">-</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">-</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">IF</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">暂停</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">ID</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">EX</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">MEM</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">WB</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">-</font> |
| `<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">sub $t2</font>` | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">-</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">-</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">-</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">IF</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">暂停</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">ID</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">EX</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">MEM</font> | <font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">WB</font> |
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2026/png/66996431/1778230094506-2edc3c8f-5daa-44a4-a019-fe5306efe450.png)
