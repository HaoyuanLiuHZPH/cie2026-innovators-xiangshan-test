...
2. axi_master(64bit)->xbar->dmac（cfg-64bit）

axi_master(64bit)->xbar->apb_master(32bit)->iopmp(cfg-32bit)
...
![画板](https://cdn.nlark.com/yuque/0/2026/jpeg/66154403/1779690268033-dec1b36e-35ab-48db-8d90-af43915bf77d.jpeg)
